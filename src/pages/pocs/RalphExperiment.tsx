 ...
 */
export default function RalphExperimentPOC() {
  ...
  return (
    <POCLayout 
      title="Ralph Experiment" 
      subtitle="Research experiment into Ralph Experiment using Three.js."
      badge="Template"
      badgeType="Template"
      pocId="ralph-experiment"
    >
      ...
      <div className="mt-8 grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-gradient-to-br from-blue-600 to-indigo-700 p-6 rounded-2xl text-white shadow-xl shadow-blue-200">
          ...
          <p className="text-xs text-blue-100 mb-4 opacity-90 leading-relaxed">
            Modify <code>src/pages/pocs/RalphExperiment.tsx</code> to start your experiment.
          </p>
